...
# save files
viewer = PETSc.Viewer()
viewer.createHDF5('A.h5', mode=PETSc.Viewer.Mode.WRITE, comm=PETSc.COMM_WORLD)
viewer.view(obj=petsc_a)
viewer.destroy()

viewer = PETSc.Viewer()
viewer.createHDF5('M.h5', mode=PETSc.Viewer.Mode.WRITE, comm=PETSc.COMM_WORLD)
viewer.view(obj=petsc_m)
viewer.destroy()
