...
The above averaged fluid densities, $\bar{\rho}_w$, $\bar{\rho}_o$ and $\bar{\rho}_g$, may be approximated to a constant value measured at a reference depth. If we put together the expressions for fluid compressibility and hydrostatic equilibrium, we conclude that density variation with depth is negligible.
