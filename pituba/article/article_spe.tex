...
When the oil phase is undersaturated, the system has an additional degree of freedom and both pressure and the amount of dissolved gas must be known to define its thermodynamic state, e.g., $\rho = \rho(p_o,Y_o)$.
...
\begin{equation}
\rho_o\left( t,z\right) \approx \rho_o\left(t,z_{datum}\right)\left[1+\frac{1}{\rho_o}\frac{\partial \rho_o}{\partial z} dz\right]
\end{equation}
For an undersaturated oil with no compositional gradient,
 ...
 \begin{equation}
\frac{1}{\rho_o}\left(\frac{\partial \rho_o}{\partial z} \right)_{T,Y_o} = \frac{1}{\rho_o}\left(\frac{\partial \rho_o}{\partial p_o} \right)\frac{\partial p_o}{\partial z} = c_o \rho_o g \, ,
 \end{equation}
 where $c_o$ is the isothermal compressibility.

 For a saturated oil,
 \begin{equation}
\frac{1}{\rho_o}\left(\frac{\partial \rho_o}{\partial z} \right)_T = \frac{1}{\rho_o}\left(\frac{\partial \rho_o}{\partial p_o} \right)_T = 
\frac{1}{\rho_o}\frac{d}{d p_o}\left(\frac{\rho_o^{ST}+R_s\rho_g^{ST}}{B_o}\right) 
 \end{equation}
