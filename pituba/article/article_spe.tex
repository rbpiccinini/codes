...
The third affirmative is proved by rewriting $d\epsilon/dp$ as a sum of four parcels, each corresponding to a different phase (three fluid phases and the rock). For the fluid phases, each parcel is composed of two factors: current volume \textit{in-situ} and volume derivative with respect to pressure:
\begin{equation}
\begin{split}
