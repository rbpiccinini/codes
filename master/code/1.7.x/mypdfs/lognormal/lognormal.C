...
namespace Foam
{
    namespace pdfs
    {
        ...
        addToRunTimeSelectionTable(pdf, lognormal, dictionary);
    }
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::pdfs::lognormal::lognormal(const dictionary& dict, Random& rndGen)
:
    ...
    a_(0.147)
{
    if (minValue_ < 0)
    {
        FatalErrorIn("lognormal::lognormal(const dictionary&, Random&)")
...
Foam::scalar Foam::pdfs::lognormal::minValue() const
{
    return minValue_;
}


Foam::scalar Foam::pdfs::lognormal::maxValue() const
{
    return maxValue_;
}


Foam::scalar Foam::pdfs::lognormal::erfInv(const scalar y) const
{
