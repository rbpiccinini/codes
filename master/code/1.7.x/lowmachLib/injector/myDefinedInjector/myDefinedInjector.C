...
defineTypeNameAndDebug(myDefinedInjector, 0);
...
Foam::myDefinedInjector::myDefinedInjector
(
    const Time& t,
    ...
    pressureIndependentVelocity_(true)
{
    ...
    {
        FatalError << "myDefinedInjector::myDefinedInjector(const time& t, const dictionary dict) " << endl
    ...
    if (mag(Xsum - 1.0) > SMALL)
    {
        WarningIn
        (
            "myDefinedInjector::myDefinedInjector(const time& t, Istream& is)"
...
void Foam::myDefinedInjector::setTangentialVectors()
{
...
Foam::label Foam::myDefinedInjector::nParcelsToInject
(
    const scalar time0,
    const scalar time1
) const
...
const Foam::vector Foam::myDefinedInjector::position(const label n) const
{
    return position_;
}

Foam::vector Foam::myDefinedInjector::position
(
    const label n,
    const scalar time,
    const bool twoD,
...
) const
{
    if (twoD)
    {
        ...
        return (is*axisOfSymmetry + (0.5*rndGen.scalar01()*d_+magInj)*halfWedge);
    }
    else
    {
...
Foam::label Foam::myDefinedInjector::nHoles() const
{
    return 1;
}

Foam::scalar Foam::myDefinedInjector::d() const
{
    return d_;
}

const Foam::vector& Foam::myDefinedInjector::direction
(
    const label i,
    const scalar time
) const
...
Foam::scalar Foam::myDefinedInjector::mass
(
    const scalar time0,
    const scalar time1,
    const bool twoD,
...
Foam::scalar Foam::myDefinedInjector::mass() const
{
    return mass_;
}

Foam::scalar Foam::myDefinedInjector::massFlowRate(const scalar time) const
{
    return getTableValue(massFlowRateProfile_, time);
}

Foam::scalar Foam::myDefinedInjector::injectionPressure(const scalar time) const
{
    return getTableValue(injectionPressureProfile_, time);
}

Foam::scalar Foam::myDefinedInjector::Cd(const scalar time) const
{
    return getTableValue(CdProfile_, time);
}

const Foam::scalarField& Foam::myDefinedInjector::X() const
{
    return X_;
}

Foam::List<Foam::myDefinedInjector::pair> Foam::myDefinedInjector::T() const
{
    return TProfile_;
}

Foam::scalar Foam::myDefinedInjector::T(const scalar time) const
{
    return T_;
}

Foam::scalar Foam::myDefinedInjector::tsoi() const
{
    return massFlowRateProfile_[0][0];
}

Foam::scalar Foam::myDefinedInjector::teoi() const
{
    return massFlowRateProfile_[massFlowRateProfile_.size()-1][0];
}

Foam::scalar Foam::myDefinedInjector::fractionOfInjection
(
    const scalar time
) const
{
...
Foam::scalar Foam::myDefinedInjector::velocity
(
    const scalar time
) const
{
...
Foam::scalar Foam::myDefinedInjector::injectedMass
(
    const scalar t
) const
{
...
void Foam::myDefinedInjector::correctProfiles
(
...
Foam::vector Foam::myDefinedInjector::tan1(const label n) const
{
    return tangentialInjectionVector1_;
}

Foam::vector Foam::myDefinedInjector::tan2(const label n) const
{
